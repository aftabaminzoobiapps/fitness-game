    ...
    return(
        <TouchableWithoutFeedback
          ...
          <View style={{...props.style,justifyContent: 'center',alignItems: 'center'}}>
                           ...
                           <ImageBackground resizeMode= 'stretch' style={{height: isPressed?"95%":"100%", width: isPressed?"95%":"100%",resizeMode: "stretch",justifyContent:'center'}} source={require('../../assets/images/Plus_Bluehdpi.png')}>
                           </ImageBackground>
